...
from models import Department, Employee, Project, EmployeeProject, db # Project, EmployeeProject
from app import app
...
df = Department(dept_code='fin', dept_name='Finance', dept_phone='555-1000')
dl = Department(dept_code='legal', dept_name='Legal', dept_phone='555-2222')
dm = Department(dept_code='mktg', dept_name='Marketing', dept_phone='555-9999')

leonard = Employee(name='Leonard', dept_code=dl.dept_code)
liz = Employee(name='Liz', dept_code=dl.dept_code)
maggie = Employee(name='Maggie', state='DC', dept_code=dm.dept_code)
